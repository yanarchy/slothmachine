...
var init = function() {
  var carousel = document.getElementById('carousel'),
      ...
      theta = 0,
      panelSize = carousel.offsetHeight;
      ...
      onNavButtonClick = function( event ){
        window.setInterval(function(){
          ...
          carousel.style[ transformProp ] = 'translateZ( -300px ) rotateX(' + theta + 'deg)';
        }, 200)
      };

      onStop = function(event) {
        console.log('STOP!');
        document.getElementById('carousel').style['animation-play-state'] = 'paused';
    ...
    navButtons[0].addEventListener( 'click', onNavButtonClick, false);
    navButtons[1].addEventListener( 'click', onStop, false);
};
